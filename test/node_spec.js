...
describe('meraki-dashboard-api node', function () {
    ...
    it('should handle getNetworkConnectivityMonitoringDestinations()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkConnectivityMonitoringDestinations',
                getNetworkConnectivityMonitoringDestinations_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkConnectivityMonitoringDestinations()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkConnectivityMonitoringDestinations',
                updateNetworkConnectivityMonitoringDestinations_networkId: '<node property>', // (1) define node properties
                updateNetworkConnectivityMonitoringDestinations_updateNetworkConnectivityMonitoringDestinations: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSmDevices()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                ...
                getNetworkSmDevices_batchSize: '<node property>', // (1) define node properties
    ...
    it('should handle getNetworkStaticRoute()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                ...
                getNetworkStaticRoute_staticRouteId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkStaticRoute()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                ...
                updateNetworkStaticRoute_staticRouteId: '<node property>', // (1) define node properties
    ...
    it('should handle deleteNetworkStaticRoute()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                ...
                deleteNetworkStaticRoute_staticRouteId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsDhcpServerPolicy()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsDhcpServerPolicy',
                getNetworkSwitchSettingsDhcpServerPolicy_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsDhcpServerPolicy()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkSwitchSettingsDhcpServerPolicy',
                updateNetworkSwitchSettingsDhcpServerPolicy_networkId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsDhcpServerPolicy_updateNetworkSwitchSettingsDhcpServerPolicy: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsDscpToCosMappings()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsDscpToCosMappings',
                getNetworkSwitchSettingsDscpToCosMappings_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsDscpToCosMappings()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkSwitchSettingsDscpToCosMappings',
                updateNetworkSwitchSettingsDscpToCosMappings_networkId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsDscpToCosMappings_updateNetworkSwitchSettingsDscpToCosMappings: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsMtu()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsMtu',
                getNetworkSwitchSettingsMtu_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsMtu()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
    ...
    it('should handle getNetworkSwitchSettingsQosRules()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsQosRules',
                getNetworkSwitchSettingsQosRules_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle createNetworkSwitchSettingsQosRule()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'createNetworkSwitchSettingsQosRule',
                createNetworkSwitchSettingsQosRule_networkId: '<node property>', // (1) define node properties
                createNetworkSwitchSettingsQosRule_createNetworkSwitchSettingsQosRule: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsQosRulesOrder()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsQosRulesOrder',
                getNetworkSwitchSettingsQosRulesOrder_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsQosRulesOrder()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkSwitchSettingsQosRulesOrder',
                updateNetworkSwitchSettingsQosRulesOrder_networkId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsQosRulesOrder_updateNetworkSwitchSettingsQosRulesOrder: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsQosRule()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsQosRule',
                getNetworkSwitchSettingsQosRule_networkId: '<node property>', // (1) define node properties
                getNetworkSwitchSettingsQosRule_qosRuleId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle deleteNetworkSwitchSettingsQosRule()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'deleteNetworkSwitchSettingsQosRule',
                deleteNetworkSwitchSettingsQosRule_networkId: '<node property>', // (1) define node properties
                deleteNetworkSwitchSettingsQosRule_qosRuleId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsQosRule()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkSwitchSettingsQosRule',
                updateNetworkSwitchSettingsQosRule_networkId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsQosRule_qosRuleId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsQosRule_updateNetworkSwitchSettingsQosRule: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsStormControl()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsStormControl',
                getNetworkSwitchSettingsStormControl_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsStormControl()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkSwitchSettingsStormControl',
                updateNetworkSwitchSettingsStormControl_networkId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsStormControl_updateNetworkSwitchSettingsStormControl: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getNetworkSwitchSettingsStp()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'getNetworkSwitchSettingsStp',
                getNetworkSwitchSettingsStp_networkId: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle updateNetworkSwitchSettingsStp()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                method: 'updateNetworkSwitchSettingsStp',
                updateNetworkSwitchSettingsStp_networkId: '<node property>', // (1) define node properties
                updateNetworkSwitchSettingsStp_updateNetworkSwitchSettingsStp: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
    ...
    it('should handle getOrganizationInventory()', function (done) {
        var flow = [
            { id: 'n1', type: 'meraki-dashboard-api', name: 'meraki-dashboard-api',
                ...
                getOrganizationInventory_includeLicenseInfo: '<node property>', // (1) define node properties
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'meraki-dashboard-api-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
